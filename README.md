...
2.	3D-print the files in the `Hardware/3D_models` folder including the tool head and optionally the deckware holder, backlight clamps and electronics casing
...
2. The glass syringe may break over time due to repeated stress from the extension of the metal plunger: It is highly recommended to 3D-print the **TPU padding** (see the `Hardware/3D_models` folder) and glue it to the bottom of the syringe.
