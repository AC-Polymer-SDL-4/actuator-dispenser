...
dispenser = Liquid_Dispenser(cnc_comport="COM5", camera_index=0, actuator_comport="COM3", virtual=False, log_level=logging.INFO)
...
res="reservoir_12"
COLOR_SPACE = 'RGB'  # 'RGB' or 'HSV' or 'LAB' or 'RGBA
# print(RESERVOIRS['waste'])

speed = 32768
#dispenser.dispense_between(source_location="reservoir_12", source_index=11, dest_location="reservoir_12", dest_index=10, transfer_vol=0.1, buffer_time=0.15, speed=speed)
dispenser.rinse_needle(wash_location=res, wash_index=RESERVOIRS['wash'], num_mixes=5, vol_pipet=0.45, speed=speed)
