...
speed = 32768
dispenser.dispense_between(source_location="reservoir_12", source_index=11, dest_location="reservoir_12", dest_index=10, transfer_vol=0.5, buffer_time=0.15, speed=speed)
